The original version is from https://github.com/ARM-software/SCALE-Sim
I changed some code to implement different functions.
...
```python3 scale.py -arch_config=configs/eyeriss.cfg -network=topologies/unit_tests/test.csv```
